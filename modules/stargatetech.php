...
if (isset($_GET['id']) && $_GET['id'] === 'upgrade') {
    ...
    if (!isset($catalogByKey[$techKey])) {
        $status = 'Unknown empire technology.';
    } else {
...
<div class="tech-shell">
    <div class="tech-hero">
        <div class="feature-hero">
            <img src="images/ui/operations-console.svg" alt="Empire technology" />
            <div>
                <h3>Empire Technology Command</h3>
                <p>Research and upgrade complete empire-era technology domains for gates, fleets, power, defense, and ancient systems.</p>
            </div>
        </div>
